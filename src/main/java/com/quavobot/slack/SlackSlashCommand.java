...
public class SlackSlashCommand {
     ...
     * then com.quavobot.slack sends a POST request to this endpoint. So, this endpoint
    ...
    public RichMessage onReceiveSlashCommand(@RequestParam("token") String token,
        ...
        if (!token.equals(slackToken)) {
            return new RichMessage("Sorry! You're not lucky enough to use our com.quavobot.slack command.");
        }
