...
public class SlackBot extends Bot {
    ...
    /**
     * Slack token from application.properties file. You can get your com.quavobot.slack token
     ...
     * NOTE: You can't reply to this event as com.quavobot.slack doesn't send
